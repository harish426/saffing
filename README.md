...
Both the `web-app` and `back_processor/mailing_system` require `.env` files for configuration (e.g., Database URLs, API keys). Ensure these are created based on requirements (not committed to git).
